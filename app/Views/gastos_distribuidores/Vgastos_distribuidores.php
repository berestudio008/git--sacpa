...
<head>
  ...
  <title>SACPA | Gastos de distribuidores</title>
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                          ...
                          <li class="nav-item">
                            <a href="<?= base_url();?>/Gastosdistribuidores" class="nav-link active">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Asignar Gasto</p>
                            </a>
                          </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>GASTOS DE DISTRIBUIDORES</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="">Id de gasto</label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;"  type="text" name="txtid_gasto" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Viatico </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtviaticos" value="" placeholder="Escriba el viatico">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona código de empleado" name="cmcodigo_empleado" data-dropdown-css-class="select2-purple" style="width: 100%;">
                ...
                <div class="form-group">
                  ...
                  <label for="">Peaje</label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtpeaje" value="" placeholder="Escriba el peaje">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Pinchazo </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtpinchazo " value="" placeholder="Escriba el pinchazo">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Total de gasto</label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txttotal_gasto " value="" >
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Fecha de gasto </label> <br>
                  <input class="form-control " style="width: 100%;"  type="date" name="txtpeaje" value="" placeholder="Escriba la fecha de gasto">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Estatus de distribución</label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona estatud de distribuición" name="cmcodigo_empleado" data-dropdown-css-class="select2-purple" style="width: 100%;">
                  <option value="Activo">A</option>
                  <option value="Inactivo">I</option>
                  </select>
                </div>
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 400px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Escriba el código de empleado">
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="btn btn-primary" href="<?= base_url();?>/Gastosdistribuidoresmostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Gastosdistribuidoresmodificar">Modificar</a></td>
