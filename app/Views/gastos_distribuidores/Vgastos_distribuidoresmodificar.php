...
<head>
  ...
  <title>SACPA |Modificar gastos de distribuidores</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>MODIFICAR GASTOS DE DISTRIBUIDORES</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <!-- /.col -->
                ...
                <div class="row">
                  <a class="btn btn-primary margin-left" href="<?= base_url();?>/Gastosdistribuidores ">Atrás</a>
