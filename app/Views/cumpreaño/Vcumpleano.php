                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                          ...
                          <li class="nav-item">
                            <a href="<?= base_url();?>/Cumpleano" class="nav-link active">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Cumpleaño</p>
                            </a>
                          </li>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Festejado</label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecione tipo fetejado" name="cmdstatus_modulo" data-dropdown-css-class="select2-purple" style="width: 100%;">
                    <option value="Activo">Todos</option>
                    <option value="Inactivo">Empleado</option>
                    <option value="Inactivo">Cliente</option>
                    <option value="Inactivo">Proveedor</option>
                  </select>
                </div>
                <!-- /.form-group -->
              </div>
