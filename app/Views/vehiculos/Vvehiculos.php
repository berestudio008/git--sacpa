...
<head>
  ...
  <title>SACPA| Regitrar vehículo</title>
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?= base_url();?>/Vehiculo" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="">Código de vehículo </label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txtcodigo_vehiculo" value="" >
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Tipo de vehículo </label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona tipo de vehículo" name="cmdtipo_vehiculo" data-dropdown-css-class="select2-purple" style="width: 100%;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="txtmatricula" value="" placeholder="Escriba la matrícula">
                </div>

                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Modelo </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtmodelo" value="" placeholder="Escriba el modelo">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="txtcolor" value="" placeholder="Escriba el color">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="txtmarca" value="" placeholder="Escriba la marca">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Linea </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtlinea" value="" placeholder="Escriba la linea">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="txtano" value="" placeholder="Escriba el año">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Vehículo de existencia  </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtvehiculo_existencia" value="" placeholder="Escriba el vehículo de axitencia">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="txtruta" value="" placeholder="Escriba la ruta">
                </div>
                <!-- /.form-group -->
                </div>
                <!-- /.col -->
                ...
                <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Localizacion ruta</label> <br>

                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3759.7792053265257!2d-71.08337408509145!3d19.55109058681716!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8eb1a5b4de9e1019%3A0x43c4f4a4b90852bf!2sDistrito%20Educativo%2009-01%20de%20Mao!5e0!3m2!1ses-419!2sdo!4v1590113246261!5m2!1ses-419!2sdo" width="1000" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
                <!-- /.form-group -->
                </div>
                <!-- /.col -->
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 400px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Escriba la matrícula">
