...
<head>
  ...
  <title>SACPA| Registrar labores</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url();?>/Labore" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Labores</p>
                </a>
              </li>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <label for="">Código labor</label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txtcodigo_labor" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Nombre de labor  </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtnombre_labor" value="" placeholder="Escriba el nombre de labor">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                ...
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Estatus de labor  </label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona estatus de labor" name="cmdstatus_labor" data-dropdown-css-class="select2-purple" style="width: 100%;">
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 400px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Escriba el código  departamento">
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="btn btn-primary" href="<?= base_url();?>/Laboremostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Laboremodificar">Modificar</a></td>
