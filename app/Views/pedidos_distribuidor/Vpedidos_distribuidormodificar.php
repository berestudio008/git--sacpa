...
<head>
  ...
  <title>SACPA| Modificar pedido distribuidor</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>MODIFICAR PEDIDOS DISTRIBUIDOR</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input disabled = "disabled"  class="form-control " style="width: 100%;" type="text" name="txttotal_pedido" value="" placeholder="Escriba el total de pedido">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              ...
              <!-- /.row -->
                ...
                <div class="row">
                  <a class="btn btn-primary margin-left" href="<?= base_url();?>/Pedidosdistribuidor ">Atrás</a>
