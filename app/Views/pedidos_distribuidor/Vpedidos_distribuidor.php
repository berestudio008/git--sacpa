...
<head>
  ...
  <title>SACPA | Pedido distribuidor</title>
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item">
                        <a href="<?= base_url();?>/Pedidosdistribuidor" class="nav-link active">
                          <i class="far fa-circle nav-icon"></i>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <label for="">Código de pedido transito </label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txtcodigo_pedido_transito" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Código de empleado  </label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona código de empleado" name="cmdcodigo_empleado" data-dropdown-css-class="select2-purple" style="width: 100%;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona código de cliente" name="cmdcodigo_cliente" data-dropdown-css-class="select2-purple" style="width: 100%;">
                  <option value="Activo">A</option>
                  <option value="Inactivo">I</option>
                  </select>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Total de pedido </label> <br>
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="date" name="txtfecha_pedido" value="" placeholder="Escriba el total de pedido">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Estatus de pedido</label> <br>
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="btn btn-primary" href="<?= base_url();?>/Pedidosdistribuidormostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Pedidosdistribuidormodificar">Modificar</a></td>
