...
<head>
  ...
  <title>SACPA| Registrar rol</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url();?>/Rol" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Rol</p>
                </a>
              </li>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txtcodigo_rol" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Estatud de rol </label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona estuatud de rol" name="cmdstatus_roles" data-dropdown-css-class="select2-purple" style="width: 100%;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="">Nombre de rol </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtnombre_rol " value="" placeholder="Escriba el nombre rol">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 400px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Escriba nombre de rol">
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="btn btn-primary" href="<?= base_url();?>/Rolesmostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Rolesmodificar">Modificar</a></td>
