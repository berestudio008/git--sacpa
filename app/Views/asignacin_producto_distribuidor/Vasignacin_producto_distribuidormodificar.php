...
<head>
  ...
  <title>SACPA| Mostrar asignación de producto vendedor</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>MOSTRAR PRODUCTO  VENDEDOR</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6">
                ...
                <div class="row">
                <a class="btn btn-primary margin-left" href="<?= base_url();?>/Productovendedo">Atrás</a>
