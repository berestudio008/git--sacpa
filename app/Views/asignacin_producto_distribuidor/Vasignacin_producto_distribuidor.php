...
<head>
  ...
  <title>SACPA | Asignación de producto vendedor</title>
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url();?>/Asignaciondeproductovendedor" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>ASIGNACIÓN DE PRODUCTO  VENDEDOR</h1>
          </div>
          <div class="col-sm-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="">Id asignación de distribuidor</label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txtid_asignacion_distribuidor" value="" >

                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Código producto</label> <br>
                  <input class="form-control" type="text" name="txtcodigo_producto" value="" placeholder="Escriba el código producto" style="width: 100%;">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                 <label for="">Código empleado</label> <br>
                  <input class="form-control" type="text" name="txtcodigo_empleado" value="" placeholder="Escriba el código empleado" style="width: 100%;">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Cantidad de asignación</label> <br>
                  <input class="form-control"  type="text" name="txtcantidad_asignada" value="" placeholder="Escriba la cantidad de asignación" style="width: 100%;">
                </div>
                <!-- /.form-group -->
              </div>
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                ...
                <label for="">Subtotal</label> <br>
                  <input  disabled="disabled" class="form-control" type="text" name="txtsubtotal" value="" style="width: 100%">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Total</label> <br>
                      <input disabled="disabled" class="form-control" type="text" name="txttotal" value="" style="width: 100%">
                  </div>
                </div>
                </div>
                <div class="row">
                  <div class="col-12 col-sm-6">
                    <div class="form-group">
                      <label for="">Fecha de asinación</label> <br>
                      <input class="form-control" type="date" name="dtfecha_asignacion" value="" style="width: 100%">
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 200px;">
                      ...
                      <input  type="date" name="txttotal" class="form-control float-right" placeholder="Escriba el producto">
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    <thead>
                      <tr>
                        ...
                        <th>Cantidad de asignación</th>
                        <th>Subtotal</th>
                        <th>Fecha de asinación</th>
                        <th>Veer</th>
                        <th>Actualizar</th>
                        <th>Eliminar</th>
                      </tr>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Bacon ipsum </td>
                        <td>Bacon ipsum </td>
                        <td><a class="btn btn-primary" href="<?= base_url();?>/Productovendedormostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Productovendedormodificar">Modificar</a></td>
