...
<head>
  ...
  <title>SACPA| Registro departamento</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url();?>/Departamentos" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Departamento</p>
                </a>
              </li>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txtcodigo_departamento" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Estatus departamento </label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona estatus departamento" name="cmdstatus_departamento" data-dropdown-css-class="select2-purple" style="width: 100%;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="">Nombre departamento</label> <br>
                  <input  class="form-control " style="width: 100%;" type="text" placeholder="Escribe el nombre departamento" name="txtnombre_departamento" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 400px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Escriba nombre departamento">
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>11-7-2014</td>
                        <td>Approved</td>
                        <td><a class="btn btn-primary" href="<?= base_url();?>/Departamentomostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Departamentomodificar">Modificar</a></td>
