...
<head>
  ...
  <title>SACPA| Registrar modulos</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url();?>/Modulo" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Modulos</p>
                </a>
              </li>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <label for="">Código de modulo</label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txtcodigo_modulo" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Estatus de modulo</label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Escriba el nombre de modulo" name="cmdstatus_modulo" data-dropdown-css-class="select2-purple" style="width: 100%;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="">Nombre de modulo </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtnombre_modulo" value="" placeholder="Escriba el nombre de modulo">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 400px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Escriba el nombre de modulo">
                ...
                <div class="card-body table-responsive p-0" style="height: 300px;">
                  <table class="table table-head-fixed text-nowrap">
                    <thead>
                      <tr>
                        <th>Código de modulo</th>
                        <th>Nombre de modulo</th>
                        <th>Estatus de modulo</th>
                        <th>Veer</th>
                        <th>Actualizar</th>
                        <th>Eliminar</th>
                      </tr>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="btn btn-primary" href="<?= base_url();?>/Modulomostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Modulomodificar">Modificar</a></td>
