...
<head>
  ...
  <title>SACPA| Reporte distribuidor </title>
                  ...
                  <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                          <li class="nav-item">
                            <a href="<?= base_url();?>/Reportedistribuidor" class="nav-link active">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Distribuidor</p>
                            </a>
                          </li>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="date" name="txtfecha_inicial" value="" >
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Vendedor </label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona el vendedor" name="cmdstatus_departamento" data-dropdown-css-class="select2-purple" style="width: 100%;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="date" name="txtfecha_final" value="" >
                </div>
                <!-- /.form-group -->
                <div class="form-group">
            ...
            <!-- /.row -->
                ...
                <div class="row">
                  <input type="submit" name="Buscar" class="btn btn-primary margin-left" value="Imprimir">
                  <input type="submit" name="Buscar" class="btn btn-primary mx-auto" value="Buscar">
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 200px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Total">
