                  ...
                  <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                          <li class="nav-item">
                            <a href="<?= base_url();?>/Cajachica" class="nav-link active">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Caja chica</p>
                            </a>
                          </li>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <label  for="">Código de caja chica</label> <br>
                  <input  class="form-control" disabled = "disabled" style="width: 100%;" type="text" name="txtcodigo_caja_chica" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Código departamento</label> <br>
                  <input class="form-control" type="text" name="txtcodigo_departamento" value="" placeholder="Escriba el código departamento" style="width: 100%;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="">Tipo de caja chica</label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona tipo caja chica" name="cmdtipo_caja_chica" data-dropdown-css-class="select2-purple" style="width: 100%;">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="date" name="dtfecha_creacion" value="" style="width: 100%;">
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="select2-purple">
                  ...
                  <label for="">Estatud  de caja</label> <br>
                    <select class="select2" multiple="multiple" data-placeholder ="Selecciona estatud  de caja" name="cmdstatus_caja" data-dropdown-css-class="select2-purple" style="width: 100%;">
                    <option value="Activo">Activo</option>
                      <option value="Inactivo">Inactivo</option>
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 400px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Escriba el tipo de caja chica">
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="btn btn-primary" href="<?= base_url();?>/Cajachicamostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Cajachicamodificar">Modificar</a></td>
