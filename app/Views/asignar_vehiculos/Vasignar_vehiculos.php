...
<head>
  ...
  <title>SACPA | Asignación de vehículo</title>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?= base_url();?>/Asignarvehiculos" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label  for="">Id de asignación</label> <br>
                  <input disabled = "disabled" class="form-control" style="width: 100%;" type="text" name="txtid_asignacion" value="" >
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Código de empleado </label> <br>
                  <input class="form-control" type="text" name="txtcodigo_empleado" value="" placeholder="Escriba el código de empleado" style="width: 100%;">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="txtcodigo_vehiculo" value=""placeholder="Escriba el código de vehículo" style="width: 100%;">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label  for="">Fecha de asignación </label> <br>
                  <input class="form-control" type="date" name="dtstatus_asignacion " value="" style="width: 100%;">
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="select2-purple">
                  ...
                  <label for="">Statud de asignación </label> <br>
                    <select class="select2" multiple="multiple" data-placeholder ="Selecciona statud" name="cbmstatus_asignacion" data-dropdown-css-class="select2-purple" style="width: 100%;">
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="btn btn-primary" href="<?= base_url();?>/Asignarvehiculosmostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Asignarvehiculosmodificar">Modificar</a></td>
