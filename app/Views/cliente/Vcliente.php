...
<head>
  ...
  <title>SACPA| Regitrar cliente</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url();?>/Cliente" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txtcodigo_cliente" value="" >
                </div>
                <!-- /.form-group -->
                <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input  class="form-control " style="width: 100%;" type="text" name="txtnombre_cliente" value="" placeholder="Escriba el nombre de cliente">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona tipo de cliente" name="cmdtipo_cliente" data-dropdown-css-class="select2-purple" style="width: 100%;">
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="txttelefono" value="" placeholder="Escriba el teléfonola " >
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="date" name="txtmovil_contacto" value="" >
                </div>
                <!-- /.form-group -->
                </div>
                <!-- /.col -->
                ...
                <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Estatud  de cliente</label> <br>
                  <select class="select2" multiple="multiple" name="cmdstatus_caja" data-placeholder ="Selecciona estatud de cliente" data-dropdown-css-class="select2-purple" style="width: 100%;">
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 400px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Escriba nombre cliente">
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Bacon ipsum </td>
                        <td>Bacon ipsum </td>
                        <td><a class="btn btn-primary" href="<?= base_url();?>/Clientemostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Clientemodificar">Modificar</a></td>
