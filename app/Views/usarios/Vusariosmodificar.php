...
<head>
  ...
  <title>SACPA | Usuario mostrar</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url();?>/Usuario" class="nav-link active">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txtid_usuario" value="" >
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Usuario</label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txt_user" value="" placeholder="Escriba el ususario">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="pass" value="" placeholder="Escriba la contraseña">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Código de rol </label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona código de rol" name="cmdcodigo_rol" data-dropdown-css-class="select2-purple" style="width: 100%;">
                  <option value="Activo">A</option>
                  <option value="Inactivo">I</option>
                  </select>
                </div>
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Estatus de usuario </label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona estatud usuario" name="cmdstatus_usuario" data-dropdown-css-class="select2-purple" style="width: 100%;">
                  <option value="Activo">A</option>
                  <option value="Inactivo">I</option>
                  </select>
                </div>
            ...
            <!-- /.row -->
                ...
                <div class="row">
                  ...
                  <a class="btn btn-primary margin-left" href="<?= base_url();?>/Usuario">Atráes</a>
