...
<head>
  ...
  <title> SACPA | Regitrar Producto</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <li class="nav-item">
                  <a href="<?= base_url();?>/Producto" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Producto</p>
                  </a>
                </li>
                  ...
                  <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item has-treeview menu-open">
                        ...
                        <li class="nav-item has-treeview menu-open">
                          <a  class="nav-link active" href="<?= base_url();?>/Login" class="nav-link ">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                              Cierre
                              <i class="right fas fa-angle-left"></i>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="txtstock" value=""  placeholder="Escriba el stock">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  <label for="">Nombre de producto </label> <br>
                  <input  class="form-control " style="width: 100%;" type="text" name="txtnombre" value="" placeholder="Escriba el nombre de producto">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Limite de stock </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtlimite_stock" value="" placeholder="Escriba la dirección">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Costo de fabrica </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtcosto_fabrica" value="" placeholder="Escriba el costo de fabrica">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Costo de venta 1 </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtcosto_venta1" value="" placeholder="Escriba el costo de venta 1">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Costo de venta 2 </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtcosto_venta2" value="" placeholder="Escriba el costo de venta 2">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Costo de venta 3  </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtcosto_venta3" value="" placeholder="Escriba elcosto de venta 3">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="date" name="txtcorreo_electronico" value="" placeholder="" >
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="date" name="fecha_vencimiento" value="" >
                </div>
                <!-- /.form-group -->
                </div>
                <!-- /.col -->
                ...
                <div class="form-group">
                  ...
                  <select class="select2" multiple="multiple" name="cmdestatud_producto" data-placeholder ="Selecciona estatud de producto" data-dropdown-css-class="select2-purple" style="width: 100%;">
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 400px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Escriba el nombre de  producto">
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="btn btn-primary" href="<?= base_url();?>/productomostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Productomodificar">Modificar</a></td>
