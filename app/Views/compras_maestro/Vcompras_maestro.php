...
<head>
  ...
  <title>SACPA| Compra proveedor</title>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <label for="">Código de compra </label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txtcodigo_compra" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Tipo de compra </label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona tipo de cliente" name="cmdtipo_compra" data-dropdown-css-class="select2-purple" style="width: 100%;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona código de proveedor" name="cmdcodigo_proveedor" data-dropdown-css-class="select2-purple" style="width: 100%;">
                  <option value="Activo">A</option>
                  <option value="Inactivo">I</option>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input placeholder="Escriba la cantidad" class="form-control " style="width: 100%;" type="text" name="txtcantidad" value="" >
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <label for="">Total de compra </label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txttotal_compra" value="" >
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Abono de compra  </label> <br>
                  <input placeholder="Escriba abono de compra" class="form-control " style="width: 100%;" type="text" name="txtabono_compra" value="" >
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Total de deuda  </label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="total_deuda" value="" >
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="date" name="txtfecha_compra" value="" >
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Estatus de ingreso </label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona estatud de ingreso" name="cmdstatus_ingreso" data-dropdown-css-class="select2-purple" style="width: 100%;">
                  <option value="Activo">A</option>
                  <option value="Inactivo">I</option>
                  </select>
                </div>
              ...
              <div class="col-12 col-sm-6">
                ...
                <div class="row">
                  <input type="submit" name="Guardar" class="btn btn-primary mx-auto" value="Guardar/Imprimir">
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 400px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Escriba nombre proveedor">
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    <thead>
                      <tr>
                        ...
                        <th>Abono de compra</th>
                        <th>Total de deuda</th>
                        <th>Fecha de compra</th>
                        <th>Estatus de ingreso</th>
                        <th>Veer</th>
                        <th>Actualizar</th>
                        <th>Eliminar</th>
                      </tr>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="btn btn-primary" href="<?= base_url();?>/Compraproveedormostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Compraproveedormodificar">Modificar</a></td>
