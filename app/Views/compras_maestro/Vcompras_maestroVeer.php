...
<head>
  ...
  <title>SACPA |  Mostrar compras maestro</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url();?>/Compraproveedor" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6">
                ...
                <div class="row">
                  <a class="btn btn-primary margin-left" href="<?= base_url();?>/Compraproveedor ">Atrás</a>
