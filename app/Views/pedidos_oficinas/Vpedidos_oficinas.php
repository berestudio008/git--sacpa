...
<head>
  ...
  <title>SACPA | Pedido oficina</title>
              ...
              <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="<?= base_url();?>/Pedidosoficinas" class="nav-link active">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Pedido Oficina</p>
                        </a>
                      </li>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <label for="">Código de pedido oficina </label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txtcodigo_pedido_oficina" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Apellidos </label> <br>
                  <input  class="form-control " style="width: 100%;" type="text" name="txtapellidos" value="" placeholder="Escriba el apellidos">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input  class="form-control " style="width: 100%;" type="text" name="txtnombres" value="" placeholder="Escriba el nombres">
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                ...
                <select class="select2" multiple="multiple" data-placeholder ="Selecciona tipo de producto" name="cmdtipo_pedido" data-dropdown-css-class="select2-purple" style="width: 100%;">
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="txtcantidad" value="" placeholder="Escriba la cantidad">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Total pedido</label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txttotal_pedido" value="" placeholder="">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Código vendedor</label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona estatus de pedido" name="cmdstatus_pedido" data-dropdown-css-class="select2-purple" style="width: 100%;">
                  <option value="Activo">A</option>
                  <option value="Inactivo">I</option>
                  </select>
                </div>
              ...
              <div class="row">
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    ...
                    <input class="form-control " style="width: 100%;" type="date" name="dtfecha_pedido" value="" placeholder="">
                  </div>
                  <!-- /.form-group -->
                </div>
                <!-- /.col -->
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <label for="">Estatud de pedido</label> <br>
                    <select class="select2" multiple="multiple" data-placeholder ="Selecciona estatus de pedido" name="cmdestatus_pedido" data-dropdown-css-class="select2-purple" style="width: 100%;">
                    <option value="Activo">A</option>
                    <option value="Inactivo">I</option>
                    </select>
                  </div>
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 400px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Escriba el código de cliente">
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="btn btn-primary" href="<?= base_url();?>/Pedidosoficinasmostrar">Mostrar</a></td>
                        <td><a class="btn btn-success" href="<?= base_url();?>/Pedidosoficinasmodificar">Modificar</a></td>
