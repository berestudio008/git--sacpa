...
<head>
  ...
  <title>SACPA | modificar proveerdor</title>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="txtcodigo_identificacion_tributario " value="" placeholder="Escriba la cédula">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6">
                ...
                <div class="row">
                  <a class="btn btn-primary margin-left" href="<?= base_url();?>/Proveedores">Atrás</a>
