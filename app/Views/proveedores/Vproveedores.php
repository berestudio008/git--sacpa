...
<head>
  ...
  <title>SACPA| Regitro proveerdor</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url();?>/Proveedores" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Proveedor</p>
                </a>
              </li>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="">Código de proveedor</label> <br>
                  <input disabled="disabled" class="form-control " style="width: 100%;" type="text" name="txtcodigo_proveedor " value="" >
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="">Cédula </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtcedula " value="" placeholder="Escriba la cédula">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="txtnombre_proveedor" value="" placeholder="Escriba el nombre proveedor">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input  class="form-control " style="width: 100%;" type="text" name="txttelefono" value="" placeholder="Escriba el télefono">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Tipo de proveedor </label> <br>
                  <select class="select2" multiple="multiple" data-placeholder ="Selecciona tipo de proveedor" name="cmdtipo_proveedor" data-dropdown-css-class="select2-purple" style="width: 100%;">
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input  class="form-control " style="width: 100%;" type="text" name="txtnombre_contacto" value="" placeholder="Escriba el nombre de contacto">
                <!-- /.form-group -->
              </div>
                </div>
              <!-- /.col -->
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="">Movil de contacto  </label> <br>
                  <input class="form-control " style="width: 100%;" type="text" name="txtmovil_contacto" value="" placeholder="Escriba el movil contacto">
               </div>
              </div>
              <!-- /.col -->
              </div>
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="txttipo_producto" value="" placeholder="Escriba el producto"  >
                </div>
                <!-- /.form-group -->
                </div>
                <!-- /.col -->
                ...
                <div class="form-group">
                  ...
                  <input class="form-control " style="width: 100%;" type="text" name="txtprecio" value="" placeholder="Escriba el precio"  >
                </div>
                <!-- /.form-group -->
                </div>
                <!-- /.col -->
                <div class="col-12 col-sm-6">
                  ...
                  <input class="form-control " style="width: 100%;" type="date" name="dtfecha_inicio" value="" >
                  </div>
                  </div>
                  <div class="row">
                  <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <label for="">Estatus de proveedores</label> <br>
                    <select class="select2" multiple="multiple" name="cmdstatus_proveedores" data-placeholder ="Selecciona estatud de proveedor" data-dropdown-css-class="select2-purple" style="width: 100%;">
                ...
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 400px;">
                      <input type="text" name="table_search" class="form-control float-right" placeholder="Escriba el código de nombre  proveedor">
